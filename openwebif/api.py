...
URL_MESSAGE = "/api/message?timeout={}&type=1&text={}"
...
class CreateDevice():
    ...
    def __init__(self, host=None, port=DEFAULT_PORT,
        ...
        :param message_timeout: The timeout for the notification
        """
        enable_logging()
    ...
    def send_message(self, text: str):
        ...
        url = self._base + URL_MESSAGE.format(str(self.message_timeout), text)
